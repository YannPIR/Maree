...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-561034.603734, 5982803.544839, -87289.620638, 6283314.015831], maxZoom: 15, minZoom: 5
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-561034.603734, 5982803.544839, -87289.620638, 6283314.015831], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte des sites d\'escalade côtiers</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (79 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Infos et contact sur mon <a href="https://github.com/YannPIR/Maree">github <\a>';
            }
