...
var lyr_Vuesatellite_0 = new ol.layer.Image({
    ...
    title: 'Vue satellite<br />' ,
        ...
        source: new ol.source.ImageStatic({
            ...
            alwaysInRange: true,
            imageExtent: [-344228.634051, 6241274.463828, -339109.443071, 6246460.081588]
        })
    });
...
lyr_spots_62.set('fieldAliases', {'fid': 'fid', 'Voies': 'Voies', 'Spot': 'Spot', });
...
lyr_spots_62.set('fieldImages', {'fid': '', 'Voies': '', 'Spot': '', });
...
lyr_spots_62.set('fieldLabels', {'fid': 'hidden field', 'Voies': 'header label - visible with data', 'Spot': 'header label - visible with data', });
